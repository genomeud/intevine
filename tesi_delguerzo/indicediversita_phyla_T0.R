...
mytra <- as.data.frame(t(myphylum))
#media della abbondanza totale del campione che userem come soglia per escludere i phyla meno abbondanti
...
write.table (shannon, ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/indice_Shannon_p_T0.txt"), quote = F)
write.table (simpson, ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/indice_Simpson_p_T0.txt"), quote = F)
write.table (chao, ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/indice_Chao_p_T0.txt"), quote = F)
...
ggplot(data = shannonmeta, aes(x=Soil, y=shannon, fill=Soil))+
  stat_compare_means(comparisons = list(c("Peat", "Manure")))+
  geom_boxplot()+
