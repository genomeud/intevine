#Installo pacchetto per aprire in excel
#install.packages("openxlsx")
library(openxlsx)
#Installo libreria per caricare file di testo install.packages("data.table")
#Carico le librerie
library(data.table)

  #T0
#Carico i dati
mydata <- fread("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/T0/T0/107841_ID2646_37-1-L_ST--REP-1-E05-ITS_S296_L001_report.txt", data.table = F)
head(mydata)
...
listfile <- list.files("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/T0/T0/")
#Ciclo for che percorre tutti i file caricati di T0
for (ciclo in 2:length(listfile)) {
  mydata <- fread(paste0("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/T0/T0/", listfile[ciclo]), data.table = F)
  #Cambio nome colonne
...
write.xlsx(myspecie, paste0 ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/", "conteggio_specie.xlsx"), row.names=F)
...
write.xlsx(mygenere, paste0 ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/", "conteggio_generi.xlsx"), row.names=F)
...
write.xlsx(myfamiglia, paste0 ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/", "conteggio_famiglie.xlsx"), row.names=F)
...
write.xlsx(myphylum, paste0 ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/", "conteggio_phyla.xlsx"), row.names=F)
