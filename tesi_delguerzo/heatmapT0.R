...
mygenere1 <- read.xlsx ("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/conteggio_generi1.xlsx")
...
conditionlist <- c("Ster_soil", "Soil")
...
for (cond in 1:length(conditionlist)) 
  ...
  write.xlsx(newcounts, "C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/tabelle_excel/normcount_T0.xlsx", row.names = TRUE)
  ...
  pheatmap(assay(vsd)[soglia,], annotation_col = pcond, annotation_colors = anncolors, fontsize=4, cellwidth=6, cellheight=4, filename = paste0("C:/Users/denis/OneDrive/Desktop/DENISE/UNIVERSITY SAN/TESI/immagini/deseq/", "heatmap_T0_", condition, ".pdf"))
}
